...
class IColumnManager(Interface):
    """ A ColumnManager is a utility that stores an ordered list of
        PortletManagers and is responsible for moving portlet Assigments from
        one PortletManager to another.
    """

    def insert(name):
        """ Insert column at the first position
        """
    ...
    def left(name):
        """ Return the name of the PortletManager left of the given
        PortletManager. Returns None if at the end of the list.
        """

    def right(name):
        """ Return the name of the PortletManager right of the given
        PortletManager. Returns None if at the beginning of the list.
        """

    def move_portlet_to_column(name, column):
        """ Move a given portlet to a target column
        """

    def get_column_name_of(name):
        """ Return the name of the ColumnManager in which the porlet is
        assigned
        """
